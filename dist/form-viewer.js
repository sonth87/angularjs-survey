...
angular.module('mwFormViewer').factory("FormQuestionId", function(){
    ...
    return {
        ...
        controllerAs: 'ctrl',
        bindToController: true,
        controller: ["$scope", "$timeout", "FormQuestionId", function($scope, $timeout,FormQuestionId){
            var ctrl = this;
            ...
            $scope.$watch(function (scope) { return scope.ctrl.questionResponse }, function (newValue, oldValue) {
                if(typeof ctrl.questionResponse === 'undefined' || !ctrl.questionResponse) {
            ...
            ctrl.toggleSelectedAnswer= function(answer){
                if(typeof ctrl.questionResponse.selectedAnswers === 'undefined' || !ctrl.questionResponse.selectedAnswers) {
                    ctrl.questionResponse.selectedAnswers = [];
                }
...
angular.module('mwFormViewer').factory("FormCodeId", function () {
    ...
    .directive('mwFormCode', function () {
        ...
        return {
            ...
            controllerAs: 'ctrl',
            bindToController: true,
            controller: ["$timeout", "FormCodeId", function ($timeout, FormCodeId) {
                var ctrl = this;
