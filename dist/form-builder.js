...
angular.module('mwFormBuilder').factory("FormQuestionBuilderId", function(){
    ...
    return {
        ...
        controller: ["$timeout", "FormQuestionBuilderId", "mwFormBuilderOptions", function($timeout,FormQuestionBuilderId, mwFormBuilderOptions){
            ...
            ctrl.hiddenField=function() {
                if(ctrl.question.hidden) {
    ...
    return {
        ...
        controller: ["mwFormUuid", function(mwFormUuid){
            ...
            ctrl.$onInit = function() {
                ...
                }else if(ctrl.pageElement.type=='code'){
                    if(!ctrl.pageElement.code){
                        ctrl.pageElement.code={
                            id: mwFormUuid.get(),
                            text: null
                        };
                    }
...
angular.module('mwFormBuilder').directive('mwFormList', ["$rootScope", function ($rootScope) {
    ...
    return {
        ...
        controllerAs: 'ctrl',
        bindToController: true,
        controller: ["$scope", "mwFormUuid", "MW_QUESTION_TYPES", function ($scope, mwFormUuid, MW_QUESTION_TYPES) {
            var ctrl = this;
...
angular.module('mwFormBuilder').factory("FormCodeBuilderId", function(){
    ...
    return {
        ...
        controllerAs: 'ctrl',
        bindToController: true,
        controller: ["$timeout", "FormCodeBuilderId", "mwFormBuilderOptions", function($timeout,FormCodeBuilderId, mwFormBuilderOptions){
            var ctrl = this;
...
angular.module('mwFormBuilder')
    ...
    .constant('MW_ELEMENT_TYPES', ['question', 'image', 'paragraph', 'code'])
